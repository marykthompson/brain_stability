...
# setwd('/Users/jeffLee/Desktop/brain_stability/notebooks/')
# sub <- '../Figures/CTS/CTS_unstable_genes.csv'
# bg <- '../Figures/CTS/bg_genes.csv'
# outdir <-'../Figures/CTS/'
# sim_co <-0.5
...
#possibleDates(hub)
# error message OrgDB is for a specific biocversion, this one is for 3.11
#Dmel <- hub[['AH79576']]
# What is a biocversion? Is it possible to install a different one without changing entire version of R???
# I think the old one had 2 genes unmapped and this one now has 11 genes unmapped
Dmel <- hub[["AH100407"]]
